...
# First Time edting this site? Uncomment (remove the #) and run this line first! 
#install.packages("dplyr","collapsibleTree","gsheet","DT","readr")
...
| Allison Londeree |          | alonderee@gmail.com               | londeree4 | The Ohio State University       |
...
#make into sheet
content <- gsheet2tbl(contenturl)

```

```{r, echo=FALSE}
collapsibleTree(content, c("Section", "Node"), collapsed = FALSE)
```
...
```{r, echo = FALSE}
#load in most recent vocab URL
vocaburl <- 'docs.google.com/spreadsheets/d/1U3Qi4Ns4POn9R8m0SEua6zU0cO5jjseMq3WrctPEtyo/edit?usp=slack&ts=5f24816f'
#make into sheet
